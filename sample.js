new Vue({
    ...
    methods: {
      addStudent: function() {
          ...
          let studentname = this.students[this.students.length - 1];
           let studentstuff = studentname.id + 1;
           return this.students.push({ id: studentstuff, name: this.name, course: this.course, period: this.period })
        }
    }
  })